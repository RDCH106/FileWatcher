...
public:
	CNotifyDirCheck();
	CNotifyDirCheck( CString csDir, NOTIFICATION_CALLBACK_PTR ncpAction, LPVOID lpData = NULL, DWORD m_dwThreadFrequency = WAIT_TIMEOUT );
	...
	DWORD							GetThreadFrequency() const { return m_dwThreadFrequency; }
	void							SetThreadFrequency( DWORD dwThreadFrequency ) { m_dwThreadFrequency = dwThreadFrequency; }
